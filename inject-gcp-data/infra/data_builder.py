...
class BuildDBData:
    ...
    def shop(self):
        ...
        return_dic["phone_number"] = (
            self.place_dic["formatted_phone_number"]
            if "formatted_phone_number" in self.place_dic
            else None
        )
    ...
    def photos(
        ...
        num_save=5,
        width=300,
        save_dir="~/Desktop/repositories/tsukumen-backend/static",
    ):
        ...
        for idx, photo in enumerate(photos):
            ...
            bin_photo = client.places_photo(photo["photo_reference"], max_width=width)
